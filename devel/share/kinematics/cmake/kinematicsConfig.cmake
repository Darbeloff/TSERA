...
if("TRUE" STREQUAL "TRUE")
  set(kinematics_SOURCE_PREFIX /home/ashikari/TSERA/src/kinematics)
  set(kinematics_DEVEL_PREFIX /home/ashikari/TSERA/devel)
  ...
  set(kinematics_INSTALL_PREFIX /home/ashikari/TSERA/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kinematics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ashikari/TSERA/src/kinematics/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ashikari/TSERA/devel/lib;/opt/ros/kinetic/lib)
