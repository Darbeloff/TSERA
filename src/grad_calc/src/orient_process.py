...
class poseClass():
	...
	def J(self, T):
		...
		0.000522598511551812* Sqrt[-6*Y^2 + 6.*(33.238054997246756 + X)*(-1.*X + Sqrt[X^2 + Y^2])] - \
     	...
     	Sqrt[-3*Y^2 + \
       	3.*(33.238054997246756 + X)*(-1.*X + Sqrt[X^2 + Y^2])]) + \
   		X*(-((0.0004525835869838045*(2.*(33.238054997246756 + X)*(-1. + \
        X/Sqrt[X^2 + Y^2]) + 2.*(-1.*X + Sqrt[X^2 + Y^2])))/\
        \
       	Sqrt[-2*Y^2 + \
        2.*(33.238054997246756 + X)*(-1.*X + Sqrt[X^2 + Y^2])]) + \
        (0.000261299255775906*(6.*(33.238054997246756 + X)*(-1. +\
        X/Sqrt[X^2 + Y^2]) + 6.*(-1.*X + Sqrt[X^2 + Y^2])))/\
        \
     	Sqrt[-6*Y^2 + \
       	6.*(33.238054997246756 + X)*(-1.*X + Sqrt[X^2 + Y^2])])\
		return J
	def arrived(self):
		self.list.pop(0)
